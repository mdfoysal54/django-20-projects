"""CivicPulse — root URL configuration."""
from django.conf import settings
from django.conf.urls.static import static
from django.contrib import admin
from django.urls import include, path

admin.site.site_header = "CivicPulse Admin"
admin.site.site_title = "CivicPulse administration"
admin.site.index_title = "Manage CivicPulse"
