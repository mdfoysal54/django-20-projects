"""RecipeBox — root URL configuration."""
from django.conf import settings
from django.conf.urls.static import static
from django.contrib import admin
from django.urls import include, path

admin.site.site_header = "RecipeBox Admin"
admin.site.site_title = "RecipeBox administration"
admin.site.index_title = "Manage RecipeBox"
