"""OrbitPay — root URL configuration."""
from django.conf import settings
from django.conf.urls.static import static
from django.contrib import admin
from django.urls import include, path

admin.site.site_header = "OrbitPay Admin"
admin.site.site_title = "OrbitPay administration"
admin.site.index_title = "Manage OrbitPay"
